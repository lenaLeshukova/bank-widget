...
* Мультиформатность: Чтение данных из файлов .json, .csv и .xlsx.
* Умная фильтрация: По статусу (EXECUTED, CANCELED, PENDING), валюте и ключевым словам в описании.
* Безопасность: Маскирование номеров карт (XXXX XX** **** XXXX) и счетов (**XXXX).
* Конвертация: Автоматический пересчет сумм из USD/EUR в RUB через внешнее API.
* Логирование: Подробная запись работы модулей utils и masks в папку logs/.
* Декораторы: Логирование начала, успешного завершения или ошибок выполнения функций.
