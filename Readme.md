...
```
## Декораторы
Декоратор для логирования работы функций. Позволяет отслеживать вызовы, успешное выполнение и ошибки, записывая данные в консоль или в файл.
* Логирование в консоль
Если вызвать декоратор без аргументов, логи будут выводиться через `print()`.

* Логирование в файл
Укажите именованный аргумент filename, чтобы сохранять историю вызовов в текстовый файл.

### Требования
Для корректной работы кода необходим импорт:
```
